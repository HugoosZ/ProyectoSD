...
def procesar_con_pig():
    ...
    try:
        ...
        comando_processing = "pig -f /app/src/pig/group.pig"
        ...
        comando_analisis = "pig -f /app/src/pig/processing.pig"
...
def main():
    ...
    ruta_csv = os.path.join(os.path.dirname(__file__), 'data_for_pig.csv')
